...
public class KeyBuilder {
    ...
    public static final String SERVICE_META_KEY_PREFIX = "com.fantasy.nacos.naming.domains.meta.";

    public static final String INSTANCE_LIST_KEY_PREFIX = "com.fantasy.nacos.naming.iplist.";
