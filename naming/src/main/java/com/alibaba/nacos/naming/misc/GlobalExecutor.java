...
import com.fantasy.nacos.common.executor.ExecutorFactory;
import com.fantasy.nacos.common.executor.NameThreadFactory;
import com.fantasy.nacos.core.utils.ClassUtils;
import com.fantasy.nacos.naming.NamingApp;
...
public class GlobalExecutor {
    ...
    private static final ExecutorService MYSQL_CHECK_EXECUTOR = ExecutorFactory.Managed
            .newFixedExecutorService(ClassUtils.getCanonicalName(NamingApp.class), DEFAULT_THREAD_COUNT,
                    new NameThreadFactory("com.fantasy.nacos.naming.mysql.checker"));
