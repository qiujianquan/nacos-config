...
public class UtilsAndCommons {
    ...
    public static final String DOMAINS_DATA_ID_PRE = "com.fantasy.nacos.naming.domains.meta.";

    public static final String IPADDRESS_DATA_ID_PRE = "com.fantasy.nacos.naming.iplist.";
    ...
    public static final String RAFT_CACHE_FILE_PREFIX = "com.fantasy.nacos.naming";
