...
package com.fantasy.nacos.naming.controllers;
...
import com.fantasy.nacos.api.naming.pojo.Cluster;
...
import com.fantasy.nacos.core.utils.WebUtils;
import com.fantasy.nacos.naming.core.Instance;
import com.fantasy.nacos.naming.core.Service;
import com.fantasy.nacos.naming.core.ServiceManager;
import com.fantasy.nacos.naming.healthcheck.HealthCheckTask;
import com.fantasy.nacos.naming.misc.UtilsAndCommons;
import com.fantasy.nacos.naming.pojo.ClusterInfo;
import com.fantasy.nacos.naming.pojo.IpAddressInfo;
import com.fantasy.nacos.naming.pojo.ServiceDetailInfo;
import com.fantasy.nacos.naming.pojo.ServiceView;
import com.fantasy.nacos.naming.web.NamingResourceParser;
...
public class CatalogController {
    ...
    public ObjectNode serviceDetail(@RequestParam(defaultValue = Constants.DEFAULT_NAMESPACE_ID) String namespaceId,
        ...
        for (com.fantasy.nacos.naming.core.Cluster cluster : detailedService.getClusterMap().values()) {
    ...
    public ObjectNode rt4Service(HttpServletRequest request) {
        ...
        for (Map.Entry<String, com.fantasy.nacos.naming.core.Cluster> entry : service.getClusterMap().entrySet()) {
