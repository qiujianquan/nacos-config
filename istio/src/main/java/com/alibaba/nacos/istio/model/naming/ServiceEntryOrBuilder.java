...
public interface ServiceEntryOrBuilder extends
   ...
   */
  java.util.List<com.fantasy.nacos.istio.model.Port>
      getPortsList();
  /**
   * <pre>
   * REQUIRED. The ports associated with the external service. If the
   ...
   * <code>repeated .istio.networking.v1alpha3.Port ports = 3;</code>
   */
  com.fantasy.nacos.istio.model.Port getPorts(int index);
  /**
   * <pre>
   * REQUIRED. The ports associated with the external service. If the
   * Endpoints are Unix domain socket addresses, there must be exactly one
   ...
   * <code>repeated .istio.networking.v1alpha3.Port ports = 3;</code>
   */
  java.util.List<? extends com.fantasy.nacos.istio.model.PortOrBuilder>
   ...
   * <code>repeated .istio.networking.v1alpha3.Port ports = 3;</code>
   */
  com.fantasy.nacos.istio.model.PortOrBuilder getPortsOrBuilder(
      int index);
   ...
   * @return The location.
   */
  com.fantasy.nacos.istio.model.naming.ServiceEntry.Location getLocation();
   ...
   */
  com.fantasy.nacos.istio.model.naming.ServiceEntry.Resolution getResolution();
   ...
   */
  java.util.List<com.fantasy.nacos.istio.model.naming.ServiceEntry.Endpoint>
      getEndpointsList();
  /**
   * <pre>
   * One or more endpoints associated with the service.
   ...
   * <code>repeated .istio.networking.v1alpha3.ServiceEntry.Endpoint endpoints = 6;</code>
   */
  com.fantasy.nacos.istio.model.naming.ServiceEntry.Endpoint getEndpoints(int index);
  /**
   * <pre>
   * One or more endpoints associated with the service.
   * </pre>
   ...
   * <code>repeated .istio.networking.v1alpha3.ServiceEntry.Endpoint endpoints = 6;</code>
   */
  java.util.List<? extends com.fantasy.nacos.istio.model.naming.ServiceEntry.EndpointOrBuilder>
   ...
   * <code>repeated .istio.networking.v1alpha3.ServiceEntry.Endpoint endpoints = 6;</code>
   */
  com.fantasy.nacos.istio.model.naming.ServiceEntry.EndpointOrBuilder getEndpointsOrBuilder(
      int index);
