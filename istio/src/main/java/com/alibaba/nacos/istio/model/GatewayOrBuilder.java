...
public interface GatewayOrBuilder extends
   ...
   */
  java.util.List<com.fantasy.nacos.istio.model.Server>
      getServersList();
  /**
   * <pre>
   * REQUIRED: A list of server specifications.
   ...
   * <code>repeated .istio.networking.v1alpha3.Server servers = 1;</code>
   */
  com.fantasy.nacos.istio.model.Server getServers(int index);
  /**
   * <pre>
   * REQUIRED: A list of server specifications.
   * </pre>
   ...
   * <code>repeated .istio.networking.v1alpha3.Server servers = 1;</code>
   */
  java.util.List<? extends com.fantasy.nacos.istio.model.ServerOrBuilder>
   ...
   * <code>repeated .istio.networking.v1alpha3.Server servers = 1;</code>
   */
  com.fantasy.nacos.istio.model.ServerOrBuilder getServersOrBuilder(
      int index);
