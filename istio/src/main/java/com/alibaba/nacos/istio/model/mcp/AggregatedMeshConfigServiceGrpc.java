...
public final class AggregatedMeshConfigServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.fantasy.nacos.istio.model.mcp.MeshConfigRequest,
      com.fantasy.nacos.istio.model.mcp.MeshConfigResponse> getStreamAggregatedResourcesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "StreamAggregatedResources",
      requestType = com.fantasy.nacos.istio.model.mcp.MeshConfigRequest.class,
      responseType = com.fantasy.nacos.istio.model.mcp.MeshConfigResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.fantasy.nacos.istio.model.mcp.MeshConfigRequest,
      com.fantasy.nacos.istio.model.mcp.MeshConfigResponse> getStreamAggregatedResourcesMethod() {
    io.grpc.MethodDescriptor<com.fantasy.nacos.istio.model.mcp.MeshConfigRequest, com.fantasy.nacos.istio.model.mcp.MeshConfigResponse> getStreamAggregatedResourcesMethod;
      ...
      synchronized (AggregatedMeshConfigServiceGrpc.class) {
        if ((getStreamAggregatedResourcesMethod = AggregatedMeshConfigServiceGrpc.getStreamAggregatedResourcesMethod) == null) {
          AggregatedMeshConfigServiceGrpc.getStreamAggregatedResourcesMethod = getStreamAggregatedResourcesMethod =
              io.grpc.MethodDescriptor.<com.fantasy.nacos.istio.model.mcp.MeshConfigRequest, com.fantasy.nacos.istio.model.mcp.MeshConfigResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "istio.mcp.v1alpha1.AggregatedMeshConfigService", "StreamAggregatedResources"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.fantasy.nacos.istio.model.mcp.MeshConfigRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.fantasy.nacos.istio.model.mcp.MeshConfigResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.fantasy.nacos.istio.model.mcp.IncrementalMeshConfigRequest,
      com.fantasy.nacos.istio.model.mcp.IncrementalMeshConfigResponse> getIncrementalAggregatedResourcesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "IncrementalAggregatedResources",
      requestType = com.fantasy.nacos.istio.model.mcp.IncrementalMeshConfigRequest.class,
      responseType = com.fantasy.nacos.istio.model.mcp.IncrementalMeshConfigResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.fantasy.nacos.istio.model.mcp.IncrementalMeshConfigRequest,
      com.fantasy.nacos.istio.model.mcp.IncrementalMeshConfigResponse> getIncrementalAggregatedResourcesMethod() {
    io.grpc.MethodDescriptor<com.fantasy.nacos.istio.model.mcp.IncrementalMeshConfigRequest, com.fantasy.nacos.istio.model.mcp.IncrementalMeshConfigResponse> getIncrementalAggregatedResourcesMethod;
      ...
      synchronized (AggregatedMeshConfigServiceGrpc.class) {
        if ((getIncrementalAggregatedResourcesMethod = AggregatedMeshConfigServiceGrpc.getIncrementalAggregatedResourcesMethod) == null) {
          AggregatedMeshConfigServiceGrpc.getIncrementalAggregatedResourcesMethod = getIncrementalAggregatedResourcesMethod =
              io.grpc.MethodDescriptor.<com.fantasy.nacos.istio.model.mcp.IncrementalMeshConfigRequest, com.fantasy.nacos.istio.model.mcp.IncrementalMeshConfigResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "istio.mcp.v1alpha1.AggregatedMeshConfigService", "IncrementalAggregatedResources"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.fantasy.nacos.istio.model.mcp.IncrementalMeshConfigRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.fantasy.nacos.istio.model.mcp.IncrementalMeshConfigResponse.getDefaultInstance()))
  ...
  public static abstract class AggregatedMeshConfigServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.fantasy.nacos.istio.model.mcp.MeshConfigRequest> streamAggregatedResources(
        io.grpc.stub.StreamObserver<com.fantasy.nacos.istio.model.mcp.MeshConfigResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.fantasy.nacos.istio.model.mcp.IncrementalMeshConfigRequest> incrementalAggregatedResources(
        io.grpc.stub.StreamObserver<com.fantasy.nacos.istio.model.mcp.IncrementalMeshConfigResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.fantasy.nacos.istio.model.mcp.MeshConfigRequest,
                com.fantasy.nacos.istio.model.mcp.MeshConfigResponse>(
                  this, METHODID_STREAM_AGGREGATED_RESOURCES)))
          .addMethod(
            getIncrementalAggregatedResourcesMethod(),
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.fantasy.nacos.istio.model.mcp.IncrementalMeshConfigRequest,
                com.fantasy.nacos.istio.model.mcp.IncrementalMeshConfigResponse>(
  ...
  private static abstract class AggregatedMeshConfigServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.fantasy.nacos.istio.model.mcp.Mcp.getDescriptor();
    }
