...
public final class ResourceSourceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.fantasy.nacos.istio.model.mcp.RequestResources,
      com.fantasy.nacos.istio.model.mcp.Resources> getEstablishResourceStreamMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "EstablishResourceStream",
      requestType = com.fantasy.nacos.istio.model.mcp.RequestResources.class,
      responseType = com.fantasy.nacos.istio.model.mcp.Resources.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.fantasy.nacos.istio.model.mcp.RequestResources,
      com.fantasy.nacos.istio.model.mcp.Resources> getEstablishResourceStreamMethod() {
    io.grpc.MethodDescriptor<com.fantasy.nacos.istio.model.mcp.RequestResources, com.fantasy.nacos.istio.model.mcp.Resources> getEstablishResourceStreamMethod;
      ...
      synchronized (ResourceSourceGrpc.class) {
        if ((getEstablishResourceStreamMethod = ResourceSourceGrpc.getEstablishResourceStreamMethod) == null) {
          ResourceSourceGrpc.getEstablishResourceStreamMethod = getEstablishResourceStreamMethod =
              io.grpc.MethodDescriptor.<com.fantasy.nacos.istio.model.mcp.RequestResources, com.fantasy.nacos.istio.model.mcp.Resources>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "istio.mcp.v1alpha1.ResourceSource", "EstablishResourceStream"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.fantasy.nacos.istio.model.mcp.RequestResources.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.fantasy.nacos.istio.model.mcp.Resources.getDefaultInstance()))
  ...
  public static abstract class ResourceSourceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.fantasy.nacos.istio.model.mcp.RequestResources> establishResourceStream(
        io.grpc.stub.StreamObserver<com.fantasy.nacos.istio.model.mcp.Resources> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.fantasy.nacos.istio.model.mcp.RequestResources,
                com.fantasy.nacos.istio.model.mcp.Resources>(
