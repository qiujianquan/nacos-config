...
public interface ServerOrBuilder extends
   ...
   * @return The port.
   */
  com.fantasy.nacos.istio.model.Port getPort();
  /**
   * <pre>
   * REQUIRED: The Port on which the proxy should listen for incoming
   * connections.
   ...
   * <code>.istio.networking.v1alpha3.Port port = 1;</code>
   */
  com.fantasy.nacos.istio.model.PortOrBuilder getPortOrBuilder();
   ...
   * @return The tls.
   */
  com.fantasy.nacos.istio.model.Server.TLSOptions getTls();
  /**
   * <pre>
   * Set of TLS related options that govern the server's behavior. Use
   * these options to control if all http requests should be redirected to
   ...
   * <code>.istio.networking.v1alpha3.Server.TLSOptions tls = 3;</code>
   */
  com.fantasy.nacos.istio.model.Server.TLSOptionsOrBuilder getTlsOrBuilder();
