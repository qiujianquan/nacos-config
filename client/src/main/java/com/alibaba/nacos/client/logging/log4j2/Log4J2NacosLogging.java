...
package com.fantasy.nacos.client.logging.log4j2;

import com.fantasy.nacos.client.logging.AbstractNacosLogging;
import com.fantasy.nacos.common.utils.ResourceUtils;
...
public class Log4J2NacosLogging extends AbstractNacosLogging {
    ...
    private static final String NACOS_LOGGER_PREFIX = "com.fantasy.nacos";
