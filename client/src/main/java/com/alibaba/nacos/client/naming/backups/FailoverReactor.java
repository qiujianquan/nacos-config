...
package com.fantasy.nacos.client.naming.backups;

import com.fantasy.nacos.api.exception.NacosException;
import com.fantasy.nacos.api.naming.pojo.ServiceInfo;
import com.fantasy.nacos.client.naming.cache.ConcurrentDiskUtil;
    ...
    public FailoverReactor(HostReactor hostReactor, String cacheDir) {
        ...
        this.executorService = new ScheduledThreadPoolExecutor(1, new ThreadFactory() {
            ...
            public Thread newThread(Runnable r) {
                ...
                thread.setName("com.fantasy.nacos.naming.failover");
                return thread;
            }
        });
        this.init();
