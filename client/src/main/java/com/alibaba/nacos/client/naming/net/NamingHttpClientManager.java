...
import com.fantasy.nacos.common.http.AbstractHttpClientFactory;
import com.fantasy.nacos.common.http.HttpClientBeanHolder;
import com.fantasy.nacos.common.http.HttpClientConfig;
import com.fantasy.nacos.common.http.HttpClientFactory;
...
public class NamingHttpClientManager implements Closeable {
    ...
    private static final int READ_TIME_OUT_MILLIS = Integer
            .getInteger("com.fantasy.nacos.client.naming.rtimeout", 50000);

    private static final int CON_TIME_OUT_MILLIS = Integer.getInteger("com.fantasy.nacos.client.naming.ctimeout", 3000);

    private static final boolean ENABLE_HTTPS = Boolean.getBoolean("com.fantasy.nacos.client.naming.tls.enable");
