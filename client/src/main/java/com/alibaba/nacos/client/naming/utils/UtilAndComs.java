...
public class UtilAndComs {
    ...
    public static final String NACOS_NAMING_LOG_NAME = "com.fantasy.nacos.naming.log.filename";

    public static final String NACOS_NAMING_LOG_LEVEL = "com.fantasy.nacos.naming.log.level";
