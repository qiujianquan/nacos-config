...
package com.fantasy.nacos.client.naming.net;

import com.fantasy.nacos.api.PropertyKeyConst;
import com.fantasy.nacos.api.SystemPropertyKeyConst;
import com.fantasy.nacos.api.common.Constants;
import com.fantasy.nacos.api.exception.NacosException;
import com.fantasy.nacos.api.naming.CommonParams;
import com.fantasy.nacos.api.naming.pojo.Instance;
import com.fantasy.nacos.api.naming.pojo.ListView;
import com.fantasy.nacos.api.naming.pojo.Service;
import com.fantasy.nacos.api.selector.AbstractSelector;
import com.fantasy.nacos.api.selector.ExpressionSelector;
import com.fantasy.nacos.api.selector.SelectorType;
import com.fantasy.nacos.client.config.impl.SpasAdapter;
import com.fantasy.nacos.client.monitor.MetricsMonitor;
import com.fantasy.nacos.client.naming.beat.BeatInfo;
import com.fantasy.nacos.client.naming.utils.CollectionUtils;
import com.fantasy.nacos.client.naming.utils.NetUtils;
import com.fantasy.nacos.client.naming.utils.SignUtil;
import com.fantasy.nacos.client.naming.utils.UtilAndComs;
import com.fantasy.nacos.client.security.SecurityProxy;
import com.fantasy.nacos.client.utils.AppNameUtils;
import com.fantasy.nacos.client.utils.TemplateUtils;
import com.fantasy.nacos.common.constant.HttpHeaderConsts;
import com.fantasy.nacos.common.http.HttpRestResult;
import com.fantasy.nacos.common.http.client.NacosRestTemplate;
import com.fantasy.nacos.common.http.param.Header;
import com.fantasy.nacos.common.http.param.Query;
import com.fantasy.nacos.common.lifecycle.Closeable;
...
import com.fantasy.nacos.common.utils.ThreadUtils;
import com.fantasy.nacos.common.utils.UuidUtils;
...
import static com.fantasy.nacos.client.utils.LogUtils.NAMING_LOGGER;
    ...
    private void initRefreshTask() {
        ...
        this.executorService = new ScheduledThreadPoolExecutor(2, new ThreadFactory() {
            ...
            public Thread newThread(Runnable r) {
                ...
                t.setName("com.fantasy.nacos.client.naming.updater");
                t.setDaemon(true);
                return t;
            }
        });
