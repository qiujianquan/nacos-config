...
package com.fantasy.nacos.client.config.http;
...
import com.fantasy.nacos.client.config.impl.ConfigHttpClientManager;
import com.fantasy.nacos.client.config.impl.ServerListManager;
import com.fantasy.nacos.client.config.impl.SpasAdapter;
import com.fantasy.nacos.client.identify.StsConfig;
    ...
    public ServerHttpAgent(Properties properties) throws NacosException {
        ...
        this.executorService = new ScheduledThreadPoolExecutor(1, new ThreadFactory() {
            ...
            public Thread newThread(Runnable r) {
                ...
                t.setName("com.fantasy.nacos.client.config.security.updater");
                t.setDaemon(true);
                return t;
            }
        });
