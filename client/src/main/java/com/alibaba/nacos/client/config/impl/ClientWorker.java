...
package com.fantasy.nacos.client.config.impl;

import com.fantasy.nacos.api.PropertyKeyConst;
import com.fantasy.nacos.api.common.Constants;
import com.fantasy.nacos.api.config.ConfigType;
import com.fantasy.nacos.api.config.listener.Listener;
import com.fantasy.nacos.api.exception.NacosException;
import com.fantasy.nacos.client.config.common.GroupKey;
import com.fantasy.nacos.client.config.filter.impl.ConfigFilterChainManager;
import com.fantasy.nacos.client.config.http.HttpAgent;
import com.fantasy.nacos.client.config.utils.ContentUtils;
import com.fantasy.nacos.client.monitor.MetricsMonitor;
import com.fantasy.nacos.client.naming.utils.CollectionUtils;
import com.fantasy.nacos.client.utils.LogUtils;
import com.fantasy.nacos.client.utils.ParamUtil;
import com.fantasy.nacos.client.utils.TenantUtil;
...
import static com.fantasy.nacos.api.common.Constants.CONFIG_TYPE;
import static com.fantasy.nacos.api.common.Constants.LINE_SEPARATOR;
import static com.fantasy.nacos.api.common.Constants.WORD_SEPARATOR;
    ...
    public ClientWorker(final HttpAgent agent, final ConfigFilterChainManager configFilterChainManager,
        ...
        this.executor = Executors.newScheduledThreadPool(1, new ThreadFactory() {
            ...
            public Thread newThread(Runnable r) {
                ...
                t.setName("com.fantasy.nacos.client.Worker." + agent.getName());
                t.setDaemon(true);
                return t;
            }
        });
        ...
        this.executorService = Executors
                .newScheduledThreadPool(Runtime.getRuntime().availableProcessors(), new ThreadFactory() {
                    ...
                    public Thread newThread(Runnable r) {
                        Thread t = new Thread(r);
                        t.setName("com.fantasy.nacos.client.Worker.longPolling." + agent.getName());
                        t.setDaemon(true);
                        return t;
                    }
                });
