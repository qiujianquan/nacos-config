...
package com.fantasy.nacos.test.core;

import com.fantasy.nacos.api.NacosFactory;
...
import com.fantasy.nacos.common.http.NSyncHttpClient;
...
import com.fantasy.nacos.config.server.service.repository.embedded.DistributedDatabaseOperateImpl;
...
import com.fantasy.nacos.test.base.HttpClient4Test;
        ...
        Runnable runnable = () -> {
            for (int i = 0; i < 3; i++) {
                try {
                    ...
                    Class<?> runnerClass = cl.loadClass("com.fantasy.nacos.Nacos");
