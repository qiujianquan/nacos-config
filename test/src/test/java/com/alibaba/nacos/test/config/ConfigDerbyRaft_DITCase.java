...
package com.fantasy.nacos.test.config;

import com.fantasy.nacos.api.config.listener.AbstractListener;
...
import com.fantasy.nacos.config.server.model.event.RaftDbErrorRecoverEvent;
...
import com.fantasy.nacos.test.core.BaseClusterTest;
...
public class ConfigDerbyRaft_DITCase extends BaseClusterTest {
    ...
    public void test_f_id_generator_leader_transfer() throws Exception {
        ...
        final String configGroup = com.fantasy.nacos.config.server.constant.Constants.CONFIG_MODEL_RAFT_GROUP;
        long preId = -1L;
        long currentId = -1L;
