...
import com.fantasy.nacos.naming.consistency.ephemeral.distro.DataStore;
...
public class NamingProxy_ITCase {
    ...
    public void testSyncData() throws NacosException, InterruptedException {
        ...
        List<com.fantasy.nacos.api.naming.pojo.Instance> allInstances = namingService.getAllInstances(serviceName, false);
        ...
        com.fantasy.nacos.api.naming.pojo.Instance dst = allInstances.get(0);
