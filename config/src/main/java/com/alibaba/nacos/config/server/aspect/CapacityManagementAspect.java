...
import com.fantasy.nacos.config.server.constant.CounterMode;
import com.fantasy.nacos.config.server.model.ConfigInfo;
import com.fantasy.nacos.config.server.model.capacity.Capacity;
import com.fantasy.nacos.config.server.service.repository.PersistService;
import com.fantasy.nacos.config.server.service.capacity.CapacityService;
...
public class CapacityManagementAspect {
    ...
    private static final String DELETE_CONFIG =
            "execution(* com.fantasy.nacos.config.server.controller.ConfigController.deleteConfig(..)) && args"
