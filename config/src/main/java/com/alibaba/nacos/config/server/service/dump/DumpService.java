...
package com.fantasy.nacos.config.server.service.dump;
...
import com.fantasy.nacos.common.utils.StringUtils;
import com.fantasy.nacos.config.server.constant.Constants;
import com.fantasy.nacos.config.server.manager.TaskManager;
...
import com.fantasy.nacos.config.server.service.ConfigCacheService;
import com.fantasy.nacos.config.server.service.datasource.DynamicDataSource;
import com.fantasy.nacos.config.server.service.dump.processor.DumpAllBetaProcessor;
import com.fantasy.nacos.config.server.service.dump.processor.DumpAllProcessor;
import com.fantasy.nacos.config.server.service.dump.processor.DumpAllTagProcessor;
import com.fantasy.nacos.config.server.service.dump.processor.DumpChangeProcessor;
import com.fantasy.nacos.config.server.service.dump.processor.DumpProcessor;
import com.fantasy.nacos.config.server.service.dump.task.DumpAllBetaTask;
import com.fantasy.nacos.config.server.service.dump.task.DumpAllTagTask;
import com.fantasy.nacos.config.server.service.dump.task.DumpAllTask;
import com.fantasy.nacos.config.server.service.dump.task.DumpChangeTask;
import com.fantasy.nacos.config.server.service.dump.task.DumpTask;
import com.fantasy.nacos.config.server.service.merge.MergeTaskProcessor;
import com.fantasy.nacos.config.server.service.repository.PersistService;
import com.fantasy.nacos.config.server.utils.ConfigExecutor;
import com.fantasy.nacos.config.server.utils.ContentUtils;
import com.fantasy.nacos.config.server.utils.DiskUtil;
import com.fantasy.nacos.config.server.utils.GroupKey;
import com.fantasy.nacos.config.server.utils.GroupKey2;
import com.fantasy.nacos.config.server.utils.LogUtil;
import com.fantasy.nacos.config.server.utils.TimeUtils;
import com.fantasy.nacos.core.cluster.ServerMemberManager;
import com.fantasy.nacos.core.utils.ApplicationUtils;
import com.fantasy.nacos.core.utils.InetUtils;
import com.fantasy.nacos.core.utils.TimerContext;
...
import static com.fantasy.nacos.config.server.utils.LogUtil.FATAL_LOG;
...
public abstract class DumpService {
    ...
    public DumpService(PersistService persistService, ServerMemberManager memberManager) {
        ...
        this.dumpTaskMgr = new TaskManager("com.fantasy.nacos.server.DumpTaskManager");
        this.dumpTaskMgr.setDefaultTaskProcessor(processor);

        this.dumpAllTaskMgr = new TaskManager("com.fantasy.nacos.server.DumpAllTaskManager");
