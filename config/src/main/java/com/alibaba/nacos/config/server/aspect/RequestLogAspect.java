...
package com.fantasy.nacos.config.server.aspect;
...
public class RequestLogAspect {
    ...
    private static final String CLIENT_INTERFACE_PUBLISH_SINGLE_CONFIG =
            "execution(* com.fantasy.nacos.config.server.controller.ConfigController.publishConfig(..)) && args"
    ...
    private static final String CLIENT_INTERFACE_GET_CONFIG =
            "execution(* com.fantasy.nacos.config.server.controller.ConfigController.getConfig(..)) && args(request,"
    ...
    private static final String CLIENT_INTERFACE_REMOVE_ALL_CONFIG =
            "execution(* com.fantasy.nacos.config.server.controller.ConfigController.deleteConfig(..)) && args(request,"
                    + "response,dataId,group,tenant,..)";
