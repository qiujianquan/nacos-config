...
import com.fantasy.nacos.config.server.service.notify.NotifyService;
    ...
    class Job implements Callable<SampleResult> {
        ...
        public SampleResult call() throws Exception {
            ...
            try {
                ...
                com.fantasy.nacos.config.server.service.notify.NotifyService.HttpResult result = NotifyService
