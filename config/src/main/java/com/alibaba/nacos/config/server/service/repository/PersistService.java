...
package com.fantasy.nacos.config.server.service.repository;
...
public interface PersistService {
     ...
     *
     * @return {@link com.fantasy.nacos.config.server.Config} list
     */
    @Deprecated
     ...
     * @param tenant            tenant
     * @param configAdvanceInfo advance info
     * @return {@link com.fantasy.nacos.config.server.Config}
     */
     ...
     *
     * @param ids id list
     * @return {@link com.fantasy.nacos.config.server.model.ConfigInfo} list
     * @author klw
     * @date 2019/7/5 16:37
     */
