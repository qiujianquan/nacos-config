...
import com.fantasy.nacos.config.server.model.AclInfo;
...
public class ClientIpWhiteList {
    ...
    public static final String CLIENT_IP_WHITELIST_METADATA = "com.fantasy.nacos.metadata.clientIpWhitelist";
