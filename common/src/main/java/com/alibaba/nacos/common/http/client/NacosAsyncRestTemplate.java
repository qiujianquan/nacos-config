...
import com.fantasy.nacos.common.http.client.request.AsyncHttpClientRequest;
...
public class NacosAsyncRestTemplate extends AbstractNacosRestTemplate {
     ...
     * @param callback     callback {@link Callback#onReceive(com.fantasy.nacos.common.model.RestResult)}
     * @throws Exception ex
     */
