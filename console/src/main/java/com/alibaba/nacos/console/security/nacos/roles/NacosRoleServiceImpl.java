...
package com.fantasy.nacos.console.security.nacos.roles;

import com.fantasy.nacos.config.server.auth.PermissionInfo;
import com.fantasy.nacos.config.server.auth.PermissionPersistService;
import com.fantasy.nacos.config.server.auth.RoleInfo;
import com.fantasy.nacos.config.server.auth.RolePersistService;
...
import com.fantasy.nacos.core.auth.Permission;
